...
import { INotification, mappingNotificationData } from '@/app/api/definitions/notification'
...
const TabContentAll = () => {
  ...
  const { data, isLoading } = useSWR(`/wp-json/notification/list?page=${pageIndex}`, fetcher)
